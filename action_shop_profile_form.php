...
<?php } else { ?>
  <div class="alert alert-success">
    ...
    <button type="button" class="btn btn-small btn-success" data-dismiss="modal" onclick="$( this ).parent().hide(); $( 'form' ).each(function () { this.reset(); }); $( '.worker' ).each(function() { $( this ).remove(); });">OK</button>
  </div>
<?php } ?>
