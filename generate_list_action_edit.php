<?php
/* File: generate_list_action_edit.php
 * Author: Amr Gaber
 * Created: 16/10/2012
...
$response  = "Success ";
$response .= "<div id=\"modalBody\" class=\"modal-body\">";
...
$response .= "<button type=\"submit\" id=\"updateButton\" class=\"btn btn-primary\">Update</button>";
$response .= "<button type=\"button\" class=\"btn\" data-dismiss=\"modal\">Cancel</button>";
